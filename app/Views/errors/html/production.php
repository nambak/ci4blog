...
<!--
    ...
    홈 링크가 href="/" 인 것은 의도적이며, 이 앱이 도메인 루트에 배포된다는
    전제를 담고 있다(운영: blog.unwanted.me). 서브패스(/blog 같은) 배포는
    지원하지 않는다 — 지원하려면 baseURL 을 읽어야 하는데, 설정을 읽는 순간
    위의 자립 계약이 깨진다. 부트 실패가 원인일 때 그 호출이 2차 예외를 낸다.
    루트 배포 전제와 자립 계약 중 후자를 택했다.
-->
<html lang="ko">
<head>
    <meta charset="UTF-8">

 ...
 * **도달성**이기 때문이다. 라이브 실측에서 글 31건 중 20건이 홈으로부터 3클릭,
 ...
 *
 * @var list<\App\Entities\Post> $archive 발행된 전체 글(최신순). 비면 아무것도 그리지 않는다.
 */
...
?>
<nav class="archive-index" aria-label="전체 글 목록">
    <h2 class="archive-index-label">전체 글 <?= count($archive) ?>편</h2>

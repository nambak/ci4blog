...
<?= $this->section('content') ?>
    ...
    <?php // 댓글 목록(부분 뷰). ?>
    <?= $this->include('comments/_list', ['comments' => $comments, 'commentCount' => $commentCount, 'post' => $post, 'likeCounts' => $likeCounts, 'likedIds' => $likedIds, 'commentPage' => $commentPage, 'hasOlderComments' => $hasOlderComments]) ?>
